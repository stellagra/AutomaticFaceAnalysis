...
- [Depresjon](https://datasets.simula.no/depresjon/) (2018): A Motor Activity Database of Depression Episodes in Unipolar and Bipolar Patients:  motor activity recordings of 23 unipolar and bipolar depressed patients and 32 healthy controls. - freely available
...
- "The Turkish Audio-Visual Bipolar Disorder Corpus", Ciftci, Kaya (2018). audio-visual Bipolar Disorder (BD) corpus for the affective computing and psychiatric communities - has become unavailable. Time period of permitted use ran out.
- 2do: scan through all AVEC, e.g. [AVEC2019](https://sites.google.com/view/avec2019/home), and check availabilty
